     ...
     <div class="max-w-7xl mx-auto">
         ...
         <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 pb-12 border-b border-gray-500/30">
             ...
             <div class="flex flex-col items-start">
                 ...
                 <div class="flex items-center gap-3">
                     ...
                     <a href="#" class="w-8 h-8 bg-[#e8d47d] text-[#5c5c5c] rounded flex items-center justify-center transition-opacity hover:opacity-90">
                         <i class="fa-brands fa-facebook-f text-base font-bold"></i>
                     </a>
                     <a href="#" class="w-8 h-8 bg-[#e8d47d] text-[#5c5c5c] rounded flex items-center justify-center transition-opacity hover:opacity-90">
             ...
             <div class="flex flex-col items-start lg:pl-8">
                 ...
                 <ul class="flex flex-col gap-4">
                     <li><a href="#" class="text-sm font-semibold text-gray-300 hover:text-[#e8d47d] transition-colors">Home</a></li>
                     <li><a href="#" class="text-sm font-semibold text-gray-300 hover:text-[#e8d47d] transition-colors">Project</a></li>
                     <li><a href="#" class="text-sm font-semibold text-gray-300 hover:text-[#e8d47d] transition-colors">Media</a></li>
                     <li><a href="#" class="text-sm font-semibold text-gray-300 hover:text-[#e8d47d] transition-colors">About</a></li>
                     <li><a href="#" class="text-sm font-semibold text-gray-300 hover:text-[#e8d47d] transition-colors">Event</a></li>
                 </ul>
             </div>
             ...
             <div class="flex flex-col items-start">
                 ...
                 <ul class="flex flex-col gap-5">
                     ...
                     <li class="flex items-center gap-3">
                         ...
                         <a href="mailto:info@alphagalleon.org" class="text-sm font-semibold text-gray-300 hover:text-[#e8d47d] transition-colors tracking-wide">info@alphagalleon.org</a>
                     </li>
                 </ul>
             </div>
         ...
         <div class="flex flex-col sm:flex-row justify-between items-center gap-4 pt-8 text-xs md:text-sm text-gray-300 font-light">
             ...
             <div class="flex items-center gap-2 font-semibold">
                 <a href="#" class="hover:text-[#e8d47d] transition-colors">Privacy policy</a>
                 <span class="text-gray-500 font-light">|</span>
                 <a href="#" class="hover:text-[#e8d47d] transition-colors">Terms & Condition</a>
             </div>
         </div>
